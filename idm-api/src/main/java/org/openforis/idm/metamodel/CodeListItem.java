...
public interface CodeListItem extends Versionable {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" container="java.util.List" aggregation="composite" inverse="item1:org.openforis.idm.metamodel.CodeListItem"
	 */
	 ...
	 * @param qualifiable  The qualifiable to set.
	 * @uml.property  name="qualifiable"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" container="java.util.List" aggregation="composite" inverse="codeListItem:org.openforis.idm.metamodel.CodeDefinition"
	 */
	public List<CodeDefinition> getCodes();

	/**
	 * Setter of the property <tt>codes</tt>
	 * @param codeDefinitions  The codes to set.
	 * @uml.property  name="codes"
	 */
