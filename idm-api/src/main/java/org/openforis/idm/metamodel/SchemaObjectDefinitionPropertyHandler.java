 ...
 * 
 */
public class SchemaObjectDefinitionPropertyHandler implements DynamicPropertyHandler {
	...
	public Object getProperty(Object object, String propertyName) {
		...
		if (propertyName.equals("__parent")) {
			SchemaObjectDefinition schemaObjectDefinition = (SchemaObjectDefinition) object;
			property = schemaObjectDefinition.getParentDefinition();
