...
public interface DistanceCheck extends ExplicitCheck {
	 ...
	 * @param destinationPointExpression  The destinationPointExpression to set.
	 * @uml.property  name="destinationPointExpression"
	 */
	 ...
	 * @param minDistanceExpression  The minDistanceExpression to set.
	 * @uml.property  name="minDistanceExpression"
	 */
	 ...
	 * @param maxDistanceExpression  The maxDistanceExpression to set.
	 * @uml.property  name="maxDistanceExpression"
	 */
	 ...
	 * @param sourcePointExpression  The sourcePointExpression to set.
	 * @uml.property  name="sourcePointExpression"
	 */
