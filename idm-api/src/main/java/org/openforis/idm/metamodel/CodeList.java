...
public interface CodeList extends Versionable {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" container="java.util.List" aggregation="composite" inverse="codeList:org.openforis.idm.metamodel.CodeListRank"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" container="java.util.List" aggregation="composite" inverse="codeList:org.openforis.idm.metamodel.CodingScheme"
	 */
	public List<CodingScheme> getCodingSchemes();

	/**
	 * Setter of the property <tt>codingSchemes</tt>
	 * @param codingSchemes  The codingSchemes to set.
	 * @uml.property  name="codingSchemes"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" container="java.util.List" aggregation="composite" inverse="codeList:org.openforis.idm.metamodel.CodeListItem"
	 */
