...
public class CoordinateOperations {
	...
	private static final Log LOG = LogFactory.getLog(CoordinateOperations.class);
	 ...
	 */
	public static synchronized double orthodromicDistance(Position startingPosition, Position destinationPosition) throws TransformException {
		CALCULATOR.setStartingPosition(startingPosition);
		CALCULATOR.setDestinationPosition(destinationPosition);
		return CALCULATOR.getOrthodromicDistance();
	}

	public static synchronized double orthodromicDistance(double startX, double startY, String startSRSId, double destX, double destY, String destSRSId) throws TransformException {
	...
	public static synchronized double orthodromicDistance(Coordinate startingCoordinate, Coordinate destinationCoordinate) throws TransformException {
	...
	public static void parseSRS(List<SpatialReferenceSystem> list) {
		for (SpatialReferenceSystem srs : list) {
			parseSRS(srs);
		}
	}

	public static void parseSRS(SpatialReferenceSystem srs) {
