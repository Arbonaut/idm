...
public interface ComparisonCheck extends TimestampCheck, NumericCheck, CodeCheck {
	 ...
	 * @param lessThanExpression  The lessThanExpression to set.
	 * @uml.property  name="lessThanExpression"
	 */
	 ...
	 * @param lessThanOrEqualsExpression  The lessThanOrEqualsExpression to set.
	 * @uml.property  name="lessThanOrEqualsExpression"
	 */
	 ...
	 * @param greaterThanExpression  The greaterThanExpression to set.
	 * @uml.property  name="greaterThanExpression"
	 */
	 ...
	 * @param greaterThanOrEqualsExpression  The greaterThanOrEqualsExpression to set.
	 * @uml.property  name="greaterThanOrEqualsExpression"
	 */
	public void setGreaterThanOrEqualsExpression(
			String greaterThanOrEqualsExpression);
	 ...
	 * @param equalsExpression  The equalsExpression to set.
	 * @uml.property  name="equalsExpression"
	 */
